    ...
    <section id="hero">
      <div className="relative bg-gradient-to-r from-blue-900 to-blue-600 min-h-[80vh] md:h-screen w-full flex items-center justify-center">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto text-white px-4 sm:px-6 md:px-12 py-12">
          {/* Title */}
          <h1 className="text-2xl sm:text-3xl md:text-3xl font-bold mb-4 text-center sm:text-left animate-fadeInUp">
            Confidence at open <br className="hidden sm:inline" />
            enrollment time.
          </h1>

          {/* Description */}
          <p className="w-80 text-base sm:text-lg md:text-xl mb-8 text-center sm:text-left animate-fadeInUp">
            This straightforward guide covers the benefit decisions that can
            protect you and your loved ones.
          </p>

          {/* Call-to-Action Button */}
          <div className="flex justify-center sm:justify-start animate-fadeInUp">
            <Link href="/">
          ...
          {/* Secondary Buttons */}
          <div className="mt-6 flex flex-wrap justify-center sm:justify-start gap-4 animate-fadeInUp">
            {/* Insure Button */}
            <Button
